...
- Cách kiểm tra kiểu dữ liệu dùng: type()
- Các kiểu dữ liệu cơ bản: int, float, bool, str, complex, NoneType
-     x = 10 (int)
-     y = 1.5 (float)
-     z = True (bool)
-     a = "Hello" (str)
-     b = 1 + 2j (complex)
-     c =  None (NoneType === Null)

### Bài 4: ép kiểu dữ liệu
- Muốn ép kiểu dũ liệu sử dụng hàm: str(), int(), float(), ...
...
### Bài 6: Các toán tử so sánh
-     Gồm: >, <, ==, !=, >=, <=

### Bài 7: Các toán tử logic
-     Gồm: and, or, not (tương đương như các ngôn ngữ khác là: &&, ||, !)

### Bài 8: Các toán tử gán và toán tử đặc biệt
-     Toán tử gán là: sự kết hợp giữa toán tử số học và toán tử =. Vd: +=, -=, *=, ...
